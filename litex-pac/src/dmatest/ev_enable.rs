...
pub type DONE_W<'a, const O: u8> = crate::BitWriter<'a, u32, EV_ENABLE_SPEC, bool, O>;
#[doc = "Field `test` reader - Write a ``1`` to enable the ``test`` Event"]
pub type TEST_R = crate::BitReader<bool>;
#[doc = "Field `test` writer - Write a ``1`` to enable the ``test`` Event"]
pub type TEST_W<'a, const O: u8> = crate::BitWriter<'a, u32, EV_ENABLE_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bit 1 - Write a ``1`` to enable the ``test`` Event"]
    #[inline(always)]
