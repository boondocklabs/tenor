...
reg  [31:0] main_bus_adr = 32'd0;
wire [31:0] main_bus_dat_w;
wire [31:0] main_bus_dat_r;
reg  [3:0] main_bus_sel = 4'd0;
reg  main_bus_cyc = 1'd0;
reg  main_bus_stb = 1'd0;
wire main_bus_ack;
reg  main_bus_we = 1'd0;
reg  [2:0] main_bus_cti = 3'd0;
reg  [1:0] main_bus_bte = 2'd0;
wire main_bus_err;
wire main_core_sink_valid;
reg  main_core_sink_ready = 1'd0;
wire main_core_sink_first;
wire main_core_sink_last;
wire [31:0] main_core_sink_payload_data;
reg  main_core_source_valid = 1'd0;
reg  [31:0] main_core_source_payload_data = 32'd0;
reg  [31:0] main_core_data = 32'd0;
reg  [31:0] main_core_counter = 32'd0;
reg  main_dma_reader_sink_valid = 1'd0;
reg  main_dma_reader_sink_ready = 1'd0;
reg  main_dma_reader_sink_last = 1'd0;
reg  [31:0] main_dma_reader_sink_payload_address = 32'd0;
reg  main_dma_reader_source_valid = 1'd0;
wire main_dma_reader_source_ready;
reg  main_dma_reader_source_first = 1'd0;
reg  main_dma_reader_source_last = 1'd0;
reg  [31:0] main_dma_reader_source_payload_data = 32'd0;
reg  [31:0] main_dma_reader_data = 32'd0;
reg  main_dma_writer_sink_valid = 1'd0;
wire main_dma_writer_sink_ready;
reg  [31:0] main_dma_writer_sink_payload_address = 32'd0;
reg  [31:0] main_dma_writer_sink_payload_data = 32'd0;
reg  main_csrfield_busy = 1'd0;
wire main_status_status;
wire main_status_we;
reg  main_status_re = 1'd0;
wire main_csrfield_enable;
wire main_csrfield_reset;
reg  [1:0] main_control_storage = 2'd0;
reg  main_control_re = 1'd0;
reg  [31:0] main_instruction_storage = 32'd0;
reg  main_instruction_re = 1'd0;
reg  [31:0] main_src_storage = 32'd0;
reg  main_src_re = 1'd0;
reg  [31:0] main_dst_storage = 32'd0;
reg  main_dst_re = 1'd0;
reg  [31:0] main_length_storage = 32'd0;
reg  main_length_re = 1'd0;
reg  main_enable_storage = 1'd0;
reg  main_enable_re = 1'd0;
reg  [31:0] main_input_storage = 32'd0;
reg  main_input_re = 1'd0;
reg  [31:0] main_output_storage = 32'd0;
reg  main_output_re = 1'd0;
reg  [31:0] main_imm_storage = 32'd0;
reg  main_imm_re = 1'd0;
reg  main_done_status = 1'd0;
wire main_done_we;
reg  main_done_re = 1'd0;
wire [31:0] main_offset_status;
wire main_offset_we;
reg  main_offset_re = 1'd0;
wire [31:0] main_tick_status;
wire main_tick_we;
reg  main_tick_re = 1'd0;
wire [31:0] main_data_status;
wire main_data_we;
reg  main_data_re = 1'd0;
wire main_fsm_reset;
wire [31:0] main_base;
reg  [31:0] main_offset = 32'd0;
wire [31:0] main_length;
...
wire builder_csr_bankarray_csrbank0_status_r;
reg  builder_csr_bankarray_csrbank0_status_we = 1'd0;
wire builder_csr_bankarray_csrbank0_status_w;
reg  builder_csr_bankarray_csrbank0_control0_re = 1'd0;
wire [1:0] builder_csr_bankarray_csrbank0_control0_r;
reg  builder_csr_bankarray_csrbank0_control0_we = 1'd0;
wire [1:0] builder_csr_bankarray_csrbank0_control0_w;
reg  builder_csr_bankarray_csrbank0_instruction0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_instruction0_r;
reg  builder_csr_bankarray_csrbank0_instruction0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_instruction0_w;
reg  builder_csr_bankarray_csrbank0_src0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_src0_r;
reg  builder_csr_bankarray_csrbank0_src0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_src0_w;
reg  builder_csr_bankarray_csrbank0_dst0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_dst0_r;
reg  builder_csr_bankarray_csrbank0_dst0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_dst0_w;
reg  builder_csr_bankarray_csrbank0_length0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_length0_r;
reg  builder_csr_bankarray_csrbank0_length0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_length0_w;
reg  builder_csr_bankarray_csrbank0_enable0_re = 1'd0;
wire builder_csr_bankarray_csrbank0_enable0_r;
reg  builder_csr_bankarray_csrbank0_enable0_we = 1'd0;
wire builder_csr_bankarray_csrbank0_enable0_w;
reg  builder_csr_bankarray_csrbank0_input0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_input0_r;
reg  builder_csr_bankarray_csrbank0_input0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_input0_w;
reg  builder_csr_bankarray_csrbank0_output0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_output0_r;
reg  builder_csr_bankarray_csrbank0_output0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_output0_w;
reg  builder_csr_bankarray_csrbank0_imm0_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_imm0_r;
reg  builder_csr_bankarray_csrbank0_imm0_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_imm0_w;
reg  builder_csr_bankarray_csrbank0_done_re = 1'd0;
wire builder_csr_bankarray_csrbank0_done_r;
reg  builder_csr_bankarray_csrbank0_done_we = 1'd0;
wire builder_csr_bankarray_csrbank0_done_w;
reg  builder_csr_bankarray_csrbank0_offset_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_offset_r;
reg  builder_csr_bankarray_csrbank0_offset_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_offset_w;
reg  builder_csr_bankarray_csrbank0_tick_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_tick_r;
reg  builder_csr_bankarray_csrbank0_tick_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_tick_w;
reg  builder_csr_bankarray_csrbank0_data_re = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_data_r;
reg  builder_csr_bankarray_csrbank0_data_we = 1'd0;
wire [31:0] builder_csr_bankarray_csrbank0_data_w;
...
reg  builder_simsoc_wishbonedmareader_state = 1'd0;
reg  builder_simsoc_wishbonedmareader_next_state = 1'd0;
reg  [31:0] main_dma_reader_data_wishbonedmareader_next_value = 32'd0;
reg  main_dma_reader_data_wishbonedmareader_next_value_ce = 1'd0;
reg  [1:0] builder_simsoc_resetinserter_state = 2'd0;
reg  [1:0] builder_simsoc_resetinserter_next_state = 2'd0;
reg  [31:0] main_offset_resetinserter_next_value = 32'd0;
reg  main_offset_resetinserter_next_value_ce = 1'd0;
reg  builder_simsoc_state = 1'd0;
reg  builder_simsoc_next_state = 1'd0;
reg  [31:0] builder_array_muxed0 = 32'd0;
...
assign main_core_sink_valid = main_dma_reader_source_valid;
assign main_dma_reader_source_ready = main_core_sink_ready;
assign main_core_sink_first = main_dma_reader_source_first;
assign main_core_sink_last = main_dma_reader_source_last;
assign main_core_sink_payload_data = main_dma_reader_source_payload_data;
assign main_base = main_src_storage[31:2];
assign main_length = main_length_storage[31:2];
assign main_fsm_reset = (~main_enable_storage);
assign main_data_status = main_data;
assign main_offset_status = main_offset;
assign main_tick_status = main_core_counter;
always @(*) begin
	builder_simsoc_wishbonedmareader_next_state <= 1'd0;
	builder_simsoc_wishbonedmareader_next_state <= builder_simsoc_wishbonedmareader_state;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
			if (main_dma_reader_source_ready) begin
				builder_simsoc_wishbonedmareader_next_state <= 1'd0;
			end
		end
		default: begin
			if ((main_bus_stb & main_bus_ack)) begin
				builder_simsoc_wishbonedmareader_next_state <= 1'd1;
			end
		end
	endcase
end
always @(*) begin
	...
	case (builder_simsoc_wishbonedmareader_state)
		...
		default: begin
			main_bus_stb <= main_dma_reader_sink_valid;
		end
	endcase
	main_bus_stb <= main_dma_writer_sink_valid;
end
always @(*) begin
	main_bus_we <= 1'd0;
	case (builder_simsoc_wishbonedmareader_state)
...
always @(*) begin
	main_dma_reader_sink_ready <= 1'd0;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
			if (main_dma_reader_source_ready) begin
				main_dma_reader_sink_ready <= 1'd1;
			end
		end
		default: begin
		end
...
always @(*) begin
	main_dma_reader_data_wishbonedmareader_next_value <= 32'd0;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
		end
		default: begin
			if ((main_bus_stb & main_bus_ack)) begin
				main_dma_reader_data_wishbonedmareader_next_value <= {main_bus_dat_r[7:0], main_bus_dat_r[15:8], main_bus_dat_r[23:16], main_bus_dat_r[31:24]};
			end
		end
	endcase
end
always @(*) begin
	main_dma_reader_data_wishbonedmareader_next_value_ce <= 1'd0;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
		end
		default: begin
			if ((main_bus_stb & main_bus_ack)) begin
				main_dma_reader_data_wishbonedmareader_next_value_ce <= 1'd1;
			end
		end
	endcase
end
always @(*) begin
	main_dma_reader_source_valid <= 1'd0;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
			main_dma_reader_source_valid <= 1'd1;
		end
		default: begin
		end
	endcase
...
always @(*) begin
	...
	case (builder_simsoc_wishbonedmareader_state)
		...
		default: begin
			main_bus_adr <= main_dma_reader_sink_payload_address;
		end
	endcase
	main_bus_adr <= main_dma_writer_sink_payload_address;
end
always @(*) begin
	main_dma_reader_source_last <= 1'd0;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
			main_dma_reader_source_last <= main_dma_reader_sink_last;
		end
		default: begin
		end
	endcase
...
always @(*) begin
	main_dma_reader_source_payload_data <= 32'd0;
	case (builder_simsoc_wishbonedmareader_state)
		1'd1: begin
			main_dma_reader_source_payload_data <= main_dma_reader_data;
		end
		default: begin
		end
	endcase
...
always @(*) begin
	...
	case (builder_simsoc_wishbonedmareader_state)
		...
		default: begin
			main_bus_cyc <= main_dma_reader_sink_valid;
		end
	endcase
	main_bus_cyc <= main_dma_writer_sink_valid;
end
assign main_bus_dat_w = {main_dma_writer_sink_payload_data[7:0], main_dma_writer_sink_payload_data[15:8], main_dma_writer_sink_payload_data[23:16], main_dma_writer_sink_payload_data[31:24]};
assign main_dma_writer_sink_ready = main_bus_ack;
always @(*) begin
	builder_simsoc_resetinserter_next_state <= 2'd0;
	builder_simsoc_resetinserter_next_state <= builder_simsoc_resetinserter_state;
	case (builder_simsoc_resetinserter_state)
		2'd2: begin
		end
		default: begin
			builder_simsoc_resetinserter_next_state <= 1'd1;
		end
	endcase
end
always @(*) begin
	main_done_status <= 1'd0;
	case (builder_simsoc_resetinserter_state)
		2'd2: begin
			main_done_status <= 1'd1;
		end
		default: begin
		end
	endcase
...
always @(*) begin
	main_offset_resetinserter_next_value <= 32'd0;
	case (builder_simsoc_resetinserter_state)
		2'd2: begin
		end
		default: begin
			main_offset_resetinserter_next_value <= 1'd0;
		end
	endcase
end
always @(*) begin
	main_offset_resetinserter_next_value_ce <= 1'd0;
	case (builder_simsoc_resetinserter_state)
		2'd2: begin
		end
		default: begin
			main_offset_resetinserter_next_value_ce <= 1'd1;
		end
	endcase
end
always @(*) begin
...
assign builder_csr_bankarray_csrbank0_status_r = builder_csr_bankarray_interface0_bank_bus_dat_w[0];
always @(*) begin
	...
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 1'd0))) begin
		builder_csr_bankarray_csrbank0_status_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
...
assign builder_csr_bankarray_csrbank0_control0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[1:0];
always @(*) begin
	...
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 1'd1))) begin
		builder_csr_bankarray_csrbank0_control0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
...
assign builder_csr_bankarray_csrbank0_instruction0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_instruction0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csr_bankarray_csrbank0_instruction0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_instruction0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 2'd2))) begin
		builder_csr_bankarray_csrbank0_instruction0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank0_src0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_src0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 2'd3))) begin
		builder_csr_bankarray_csrbank0_src0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_src0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 2'd3))) begin
		builder_csr_bankarray_csrbank0_src0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
assign builder_csr_bankarray_csrbank0_dst0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_dst0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd4))) begin
		builder_csr_bankarray_csrbank0_dst0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_dst0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd4))) begin
		builder_csr_bankarray_csrbank0_dst0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
assign builder_csr_bankarray_csrbank0_length0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_length0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd5))) begin
		builder_csr_bankarray_csrbank0_length0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_length0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd5))) begin
		builder_csr_bankarray_csrbank0_length0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank0_enable0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[0];
always @(*) begin
	builder_csr_bankarray_csrbank0_enable0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd6))) begin
		builder_csr_bankarray_csrbank0_enable0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_enable0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd6))) begin
		builder_csr_bankarray_csrbank0_enable0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
assign builder_csr_bankarray_csrbank0_input0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_input0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd7))) begin
		builder_csr_bankarray_csrbank0_input0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_input0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 3'd7))) begin
		builder_csr_bankarray_csrbank0_input0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank0_output0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_output0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd8))) begin
		builder_csr_bankarray_csrbank0_output0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_output0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd8))) begin
		builder_csr_bankarray_csrbank0_output0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank0_imm0_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_imm0_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd9))) begin
		builder_csr_bankarray_csrbank0_imm0_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_imm0_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd9))) begin
		builder_csr_bankarray_csrbank0_imm0_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
assign builder_csr_bankarray_csrbank0_done_r = builder_csr_bankarray_interface0_bank_bus_dat_w[0];
always @(*) begin
	builder_csr_bankarray_csrbank0_done_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd10))) begin
		builder_csr_bankarray_csrbank0_done_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_done_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd10))) begin
		builder_csr_bankarray_csrbank0_done_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank0_offset_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_offset_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd11))) begin
		builder_csr_bankarray_csrbank0_offset_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_offset_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd11))) begin
		builder_csr_bankarray_csrbank0_offset_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
assign builder_csr_bankarray_csrbank0_tick_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_tick_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd12))) begin
		builder_csr_bankarray_csrbank0_tick_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_tick_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd12))) begin
		builder_csr_bankarray_csrbank0_tick_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
assign builder_csr_bankarray_csrbank0_data_r = builder_csr_bankarray_interface0_bank_bus_dat_w[31:0];
always @(*) begin
	builder_csr_bankarray_csrbank0_data_we <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd13))) begin
		builder_csr_bankarray_csrbank0_data_we <= (~builder_csr_bankarray_interface0_bank_bus_we);
	end
end
always @(*) begin
	builder_csr_bankarray_csrbank0_data_re <= 1'd0;
	if ((builder_csr_bankarray_csrbank0_sel & (builder_csr_bankarray_interface0_bank_bus_adr[8:0] == 4'd13))) begin
		builder_csr_bankarray_csrbank0_data_re <= builder_csr_bankarray_interface0_bank_bus_we;
	end
end
assign main_status_status = main_csrfield_busy;
assign builder_csr_bankarray_csrbank0_status_w = main_status_status;
assign main_status_we = builder_csr_bankarray_csrbank0_status_we;
assign main_csrfield_enable = main_control_storage[0];
assign main_csrfield_reset = main_control_storage[1];
assign builder_csr_bankarray_csrbank0_control0_w = main_control_storage[1:0];
assign builder_csr_bankarray_csrbank0_instruction0_w = main_instruction_storage[31:0];
assign builder_csr_bankarray_csrbank0_src0_w = main_src_storage[31:0];
assign builder_csr_bankarray_csrbank0_dst0_w = main_dst_storage[31:0];
assign builder_csr_bankarray_csrbank0_length0_w = main_length_storage[31:0];
assign builder_csr_bankarray_csrbank0_enable0_w = main_enable_storage;
assign builder_csr_bankarray_csrbank0_input0_w = main_input_storage[31:0];
assign builder_csr_bankarray_csrbank0_output0_w = main_output_storage[31:0];
assign builder_csr_bankarray_csrbank0_imm0_w = main_imm_storage[31:0];
assign builder_csr_bankarray_csrbank0_done_w = main_done_status;
assign main_done_we = builder_csr_bankarray_csrbank0_done_we;
assign builder_csr_bankarray_csrbank0_offset_w = main_offset_status[31:0];
assign main_offset_we = builder_csr_bankarray_csrbank0_offset_we;
assign builder_csr_bankarray_csrbank0_tick_w = main_tick_status[31:0];
assign main_tick_we = builder_csr_bankarray_csrbank0_tick_we;
assign builder_csr_bankarray_csrbank0_data_w = main_data_status[31:0];
assign main_data_we = builder_csr_bankarray_csrbank0_data_we;
...
assign builder_csr_bankarray_csrbank1_reset0_w = main_reset_storage[1:0];
assign builder_csr_bankarray_csrbank1_scratch0_w = main_scratch_storage[31:0];
assign builder_csr_bankarray_csrbank1_bus_errors_w = main_bus_errors_status[31:0];
assign main_bus_errors_we = builder_csr_bankarray_csrbank1_bus_errors_we;
...
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed0 <= main_bus_adr;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed1 <= main_bus_dat_w;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed2 <= main_bus_sel;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed3 <= main_bus_cyc;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed4 <= main_bus_stb;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed5 <= main_bus_we;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed6 <= main_bus_cti;
		end
	endcase
end
always @(*) begin
	...
	case (builder_grant)
		...
		default: begin
			builder_array_muxed7 <= main_bus_bte;
		end
	endcase
end
...
always @(posedge sys_clk_1) begin
	...
	if (main_core_sink_valid) begin
		main_core_sink_ready <= 1'd1;
		main_core_data <= main_core_sink_payload_data;
		main_core_source_payload_data <= main_core_data;
		main_core_source_valid <= 1'd1;
	end
	main_core_counter <= (main_core_counter + 1'd1);
	builder_simsoc_wishbonedmareader_state <= builder_simsoc_wishbonedmareader_next_state;
	if (main_dma_reader_data_wishbonedmareader_next_value_ce) begin
		main_dma_reader_data <= main_dma_reader_data_wishbonedmareader_next_value;
	end
	builder_simsoc_resetinserter_state <= builder_simsoc_resetinserter_next_state;
	if (main_offset_resetinserter_next_value_ce) begin
		main_offset <= main_offset_resetinserter_next_value;
	end
	if (main_fsm_reset) begin
		main_offset <= 32'd0;
		builder_simsoc_resetinserter_state <= 2'd0;
	end
	...
	if (builder_csr_bankarray_csrbank0_sel) begin
		case (builder_csr_bankarray_interface0_bank_bus_adr[8:0])
			...
			2'd2: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_instruction0_w;
			end
			2'd3: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_src0_w;
			end
			3'd4: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_dst0_w;
			end
			3'd5: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_length0_w;
			end
			3'd6: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_enable0_w;
			end
			3'd7: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_input0_w;
			end
			4'd8: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_output0_w;
			end
			4'd9: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_imm0_w;
			end
			4'd10: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_done_w;
			end
			4'd11: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_offset_w;
			end
			4'd12: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_tick_w;
			end
			4'd13: begin
				builder_csr_bankarray_interface0_bank_bus_dat_r <= builder_csr_bankarray_csrbank0_data_w;
			end
		endcase
	end
	main_status_re <= builder_csr_bankarray_csrbank0_status_re;
	if (builder_csr_bankarray_csrbank0_control0_re) begin
		main_control_storage[1:0] <= builder_csr_bankarray_csrbank0_control0_r;
	end
	main_control_re <= builder_csr_bankarray_csrbank0_control0_re;
	if (builder_csr_bankarray_csrbank0_instruction0_re) begin
		main_instruction_storage[31:0] <= builder_csr_bankarray_csrbank0_instruction0_r;
	end
	main_instruction_re <= builder_csr_bankarray_csrbank0_instruction0_re;
	if (builder_csr_bankarray_csrbank0_src0_re) begin
		main_src_storage[31:0] <= builder_csr_bankarray_csrbank0_src0_r;
	end
	main_src_re <= builder_csr_bankarray_csrbank0_src0_re;
	if (builder_csr_bankarray_csrbank0_dst0_re) begin
		main_dst_storage[31:0] <= builder_csr_bankarray_csrbank0_dst0_r;
	end
	main_dst_re <= builder_csr_bankarray_csrbank0_dst0_re;
	if (builder_csr_bankarray_csrbank0_length0_re) begin
		main_length_storage[31:0] <= builder_csr_bankarray_csrbank0_length0_r;
	end
	main_length_re <= builder_csr_bankarray_csrbank0_length0_re;
	if (builder_csr_bankarray_csrbank0_enable0_re) begin
		main_enable_storage <= builder_csr_bankarray_csrbank0_enable0_r;
	end
	main_enable_re <= builder_csr_bankarray_csrbank0_enable0_re;
	if (builder_csr_bankarray_csrbank0_input0_re) begin
		main_input_storage[31:0] <= builder_csr_bankarray_csrbank0_input0_r;
	end
	main_input_re <= builder_csr_bankarray_csrbank0_input0_re;
	if (builder_csr_bankarray_csrbank0_output0_re) begin
		main_output_storage[31:0] <= builder_csr_bankarray_csrbank0_output0_r;
	end
	main_output_re <= builder_csr_bankarray_csrbank0_output0_re;
	if (builder_csr_bankarray_csrbank0_imm0_re) begin
		main_imm_storage[31:0] <= builder_csr_bankarray_csrbank0_imm0_r;
	end
	main_imm_re <= builder_csr_bankarray_csrbank0_imm0_re;
	main_done_re <= builder_csr_bankarray_csrbank0_done_re;
	main_offset_re <= builder_csr_bankarray_csrbank0_offset_re;
	main_tick_re <= builder_csr_bankarray_csrbank0_tick_re;
	main_data_re <= builder_csr_bankarray_csrbank0_data_re;
	...
	if (builder_csr_bankarray_csrbank1_reset0_re) begin
		main_reset_storage[1:0] <= builder_csr_bankarray_csrbank1_reset0_r;
	end
	main_reset_re <= builder_csr_bankarray_csrbank1_reset0_re;
	if (builder_csr_bankarray_csrbank1_scratch0_re) begin
		main_scratch_storage[31:0] <= builder_csr_bankarray_csrbank1_scratch0_r;
	end
	main_scratch_re <= builder_csr_bankarray_csrbank1_scratch0_re;
	main_bus_errors_re <= builder_csr_bankarray_csrbank1_bus_errors_re;
	...
	if (sys_rst) begin
		...
		main_core_sink_ready <= 1'd0;
		main_core_source_valid <= 1'd0;
		main_core_source_payload_data <= 32'd0;
		main_core_data <= 32'd0;
		main_core_counter <= 32'd0;
		main_dma_reader_data <= 32'd0;
		main_status_re <= 1'd0;
		main_control_storage <= 2'd0;
		main_control_re <= 1'd0;
		main_instruction_storage <= 32'd0;
		main_instruction_re <= 1'd0;
		main_src_storage <= 32'd0;
		main_src_re <= 1'd0;
		main_dst_storage <= 32'd0;
		main_dst_re <= 1'd0;
		main_length_storage <= 32'd0;
		main_length_re <= 1'd0;
		main_enable_storage <= 1'd0;
		main_enable_re <= 1'd0;
		main_input_storage <= 32'd0;
		main_input_re <= 1'd0;
		main_output_storage <= 32'd0;
		main_output_re <= 1'd0;
		main_imm_storage <= 32'd0;
		main_imm_re <= 1'd0;
		main_done_re <= 1'd0;
		main_offset_re <= 1'd0;
		main_tick_re <= 1'd0;
		...
		builder_simsoc_wishbonedmareader_state <= 1'd0;
		builder_simsoc_resetinserter_state <= 2'd0;
...
//------------------------------------------------------------------------------
// Memory rom: 5854-words x 32-bit
//------------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-08-22 12:36:33.
//------------------------------------------------------------------------------
