...
def main():
    ...
    target_group.add_argument("--device",          default="85F",        help="ECP5 device (25F, 45F or 85F).")
    ...
    target_group.add_argument("--with-spi-sdcard", action="store_false",  help="Enable SPI-mode SDCard support.")
    builder_args(parser)
